...
function getContents(msg, url) {
  ...
  // the outside [] is used for translation, the inside [] is regulated expression
  // this will return all urls without any overlapping, considering in the chooseEmoji()
  // function, the emojis are inserting with []s
  let arr = msg.match(/\[ [^\[\]]+ \]/g);
  for (let i in arr) {
